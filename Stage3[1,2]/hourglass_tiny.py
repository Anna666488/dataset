...
class HourglassModel():
    ...
    def __init__(self, nFeat=512, nStack=4, nModules=1, nLow=4, outputDim=16, batch_size=16, drop_rate=0.2,
        ...
        #新加的部分，为了进行跨层的信息传输
        self.stage_stack = 0
        self.One_stage = [None] * 4
        self.Two_stage = [None] * 4
    # ACCESSOR
    ...
    def vis(self,img_cv2,points,points_g,point_pairs,epoch,heatmap_1,fun,stage,i):
        ...
        for jdx in range(1):
            ...
            plt.axis("off")
            plt.savefig('F:/wenxin_/2020.7.22_/STGAE3/STAGE3_NEW/key_vis/' + str(epoch) + '_' + str(stage) + '_'+str(i) + str(fun))
    ...
    def get_point(self,demo_stage_heatmap,ground_heatmap,img_height,img_width,num_points,H,W,stage,epoch,i):
        ...
        logfile = 'F:/wenxin_/2020.7.22_/STGAE3/STAGE3_NEW/joints.txt'
        fobj = open(logfile, 'a')
    ...
    def _train(self, nEpochs=10, epochSize=1000, saveStep=500, validIter=8): #这里默认为10次
        """
		"""
        with tf.name_scope('Train'):
            ...
            for epoch in range(nEpochs):
                ...
                with tf.name_scope('save'):
                    ...
                    self.saver.save(self.Session, os.path.join(os.getcwd(),'Save_stage3_conec1-2_2', str(self.name + '_' + str(epoch + 1))))
                ...
                if epoch == 100 :  #这里是为了再次从上次跑结果基础上再继续
                    fun = 'train_data'
                    ...
                    for stage in range(stack):
                        ...
                        for i in range(16):
                            ...
                            plt.colorbar()
                            plt.axis('off')
                        plt.savefig('F:/wenxin_/2020.7.22_/STGAE3/STAGE3_NEW/m_results/' + str(epoch) + '_' + str(stage))
                        #plt.savefig('F:/wenxin_/Experiment_7.7/aug_7/m_results/' + str(epoch) + '_' + str(stage))
                        #plt.savefig('F:/wenxin_/shiyan_7.15/m_results_2/' + str(epoch) + '_' + str(stage))
                            #之前保存在F:\wenxin_\results
                            #F:/wenxin_/results/medium_results_7.14
                ...
                #记录下中间结果：
                #logfile = 'F:/wenxin_/Experiment_7.7/xiangmu/xiangmu_1_1_lab/record.txt'
                #logfile = 'F:/wenxin_/original_datasets/record.txt'
                #logfile = 'F:/wenxin_/shiyan_7.15/record_2.txt'
                #logfile = 'F:/wenxin_/Experiment_7.7/aug_7/record.txt'
                logfile = 'E:/xiao/Data_new_7.16/STAGE3_NEW/STGAE3/STAGE3_NEW/record_2.txt'
                fobj = open(logfile, 'a')
                fobj.write('epoch: ' + str(epoch) + '\n')
    ...
    def training_init(self,nEpochs=20, epochSize=2500, saveStep=100, dataset=None, load = 'E:/xiao/Data_new_7.16/STAGE3_NEW/STGAE3/STAGE3_NEW/Save_stage3_conec1-2/hg_network_53'):
    ...
    def _hourglass_4(self, inputs, n, numOut, name='hourglass_4'):
        ...
        with tf.name_scope(name):
            ...
            if n > 0:
                low_2 = self._hourglass_(low_1, n - 1, numOut, name='low_2')
            else:
