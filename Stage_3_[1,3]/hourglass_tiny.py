...
class HourglassModel():
    ...
    def vis(self,img_cv2,points,points_g,point_pairs,epoch,heatmap_1,fun,stage,i):
        ...
        for jdx in range(1):
            ...
            plt.axis("off")
            plt.savefig('E:/xiao/Data_new_7.16/Stage_3_[1,3]/key_vis/' + str(epoch) + '_' + str(stage) + '_'+str(i) + str(fun))
    ...
    def get_point(self,demo_stage_heatmap,ground_heatmap,img_height,img_width,num_points,H,W,stage,epoch,i):
        ...
        logfile = 'E:/xiao/Data_new_7.16/Stage_3_[1,3]/joints.txt'
        fobj = open(logfile, 'a')
        ...
        with tf.name_scope('Train'):
            ...
            for epoch in range(nEpochs):
                ...
                with tf.name_scope('save'):
                    ...
                    self.saver.save(self.Session, os.path.join(os.getcwd(),'Save3_conect1and3_3', str(self.name + '_' + str(epoch + 1))))
                ...
                if epoch == 100:
                    ...
                    for stage in range(stack):
                        ...
                        for i in range(16):
                            ...
                            plt.colorbar()
                            plt.axis('off')
                        plt.savefig('E:/xiao/Data_new_7.16/Stage_3_[1,3]/m_results/' + str(epoch) + '_' + str(stage))
                ...
                logfile = 'E:/xiao/Data_new_7.16/Stage_3_[1,3]/record_3.txt'
                fobj = open(logfile, 'a')
                fobj.write('epoch: ' + str(epoch) + '\n')
    ...
    def training_init(self,nEpochs=20, epochSize=2500, saveStep=100, dataset=None, load ='E:/xiao/Data_new_7.16/STAGE3_NEW/Stage_3_[1,3]/Save3_conect1and3_2/hg_network_6'):
        ...
        with tf.name_scope('model'):
            ...
            ##而此项目采用的是以下的堆叠沙漏过程
                ...
                with tf.name_scope('stacks'):
                    ...
                    for i in range(1, self.nStack - 1):
                        with tf.name_scope('stage_' + str(i)):
                            hg[i] = self._hourglass_3_(sum_[i - 1], self.nLow, self.nFeat, 'hourglass')
                            drop[i] = tf.layers.dropout(hg[i], rate=self.dropout_rate, training=self.training,
                                                        name='dropout')
